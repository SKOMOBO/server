const {authenticate, validate_data} = require("../src/validator")
...
describe('validate_data says data is invalid', ()=>{
    test('null is invalid', ()=>{
        expect(validate_data(null)).toBe(false)
    })

    test('undefined is invalid', ()=>{
        expect(validate_data(undefined)).toBe(false)
    })

    test('space is invalid', ()=>{
        expect(validate_data(' ')).toBe(false)
    })
